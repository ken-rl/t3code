...
/**
 * The index route is the project fieldbook. It stays stable across projects so
 * users can orient themselves before opening a thread or delegating a task.
 */
function DashboardLanding() {
  ...
  return projects.length > 0 ? <ProjectDashboard /> : <NoProjectsHero />;
}
